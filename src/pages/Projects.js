...
export default function Projects() {
    const projectList = [
        {   title: "NestNotifications", 
            ...
            description: "My team and I created a location sharing mobile app with a Flutter frontend and Flask backend. We placed 4th out of over 200 participants at INRIX Hack 2022."
        },
        {   title: "Chess", 
